...
3. Right-click tray icon → "Open Settings"
4. Add folders to Group A using Browse button
...
Group A: "Daily Projects"
  - Hotkey: Ctrl+Alt+F1
  - Folders: Add your main project folders
  - Behavior: Stack + Resize
  
Group B: "Quick Reference"
  - Hotkey: Ctrl+Alt+F2  
  - Folders: Documentation, Templates
  - Behavior: Dual Vertical (if 2 folders)
```
...
Copyright © 2026 AndrianAngel (GitHub)
...
- Resell or distribute for profit
...
https://github.com/AndrianAngel/Easy-Folder-Group-Manager
```
